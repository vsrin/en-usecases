...
export default function UseCaseDetailPage() {
  ...
  if (!useCase) {
    return (
      <div className={`min-h-screen flex items-center justify-center pt-16 ${isDark ? 'bg-en-navy' : 'bg-lt-bg'}`}>
  ...
  return (
    <div className="min-h-screen bg-en-paper pt-16">
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-7xl mx-auto px-6 py-4">
